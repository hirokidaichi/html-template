        ...
        if (!this.isCompiled) {
            ...
            if (HTML.Template.Cache[uniq]) {
                ...
                try{
                    ...
                    console.log("HTML_TEMPLATE_ERROR:"+uniq+" can't compile.");
...
HTML.Template.Element.prototype = {
    ...
    getParam: function() {
        ...
        if (this.attributes['expr']) {
            return "(function(){with(_GLOBAL_FUNCTION){with(_TOP_LEVEL){return " + this.attributes['expr'] + "}}}).apply(this)";
        }
    }
};
        ...
        getCode: function() {
            if (this.isClose()) {
                ...
                return [
                    ...
                    'var _GLOBAL_FUNCTION = Object.extend({},HTML.Template.GLOBAL_FUNC);',
                    '_GLOBAL_FUNCTION=Object.extend(_GLOBAL_FUNCTION,this._funcs);',
